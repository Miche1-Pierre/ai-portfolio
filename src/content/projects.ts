...
export type Project = {
  ...
  /** Palette tone of the project (DA v3): pastel panel behind its screenshots, bullets, pill. */
  tone: Tone;
...
export const projects: Project[] = [
  {
    ...
    approach: [
      ...
      "Deployed across two VMs on a private Tailscale mesh behind a Cloudflare Tunnel edge; ~11 containerised services on Nginx via Docker Compose, GHCR and GitHub Actions CI/CD (CodeQL, OWASP ZAP, Trivy, Semgrep).",
      "Full observability: Prometheus scraping with Grafana dashboards and Alertmanager, host and per-container exporters, and OpenTelemetry traces into SigNoz.",
    ...
    stackGroups: [
      ...
      { label: "Infra & DevOps", items: ["Docker Compose", "Nginx", "Cloudflare Tunnel", "Tailscale", "GHCR", "GitHub Actions"] },
      { label: "Observability", items: ["Prometheus", "Grafana", "Alertmanager", "OpenTelemetry", "SigNoz", "Micrometer"] },
      { label: "Security", items: ["OAuth2 / RS256 JWT", "RBAC", "TOTP 2FA", "CSP / HSTS", "Rate limiting (Bucket4j)", "Encrypted secrets", "Turnstile", "SSRF guard", "CodeQL", "OWASP ZAP", "Trivy", "Semgrep"] },
    ],
    links: {
  ...
  },
  {
    ...
    problem:
      "On every new conversation an AI assistant re-scans everything and loses the thread, while documentation scatters across tools and goes stale.",
    approach: [
    ...
    results: [
      ...
      "Free tier ships the full vault and templates; a paid tier adds MCP and agent orchestration.",
    ...
    images: ["/images/projects/brain-os/brain-os_1.png"],
    stack: ["Markdown", "MCP", "Obsidian", "Claude", "Knowledge base"],
  ...
  },
  {
    ...
    links: { site: "https://www.plania.ai" },
    cover: "/images/projects/plania/plania_1.png",
    images: ["/images/projects/plania/plania_1.png"],
    access: "Commercial product; the source is private.",
  ...
  },
  {
    ...
    approach: [
      "A production LLM agent with guardrails and grounded answers (RAG) over the carrier's services.",
      "Wired directly into the spot-quote request funnel.",
